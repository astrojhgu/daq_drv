    ...
    while (1)
        {
            ...
            for (size_t i = 0; i < NNODES; ++i)
                {
                    gpuErrchk (cudaMemcpy ((void *)(input_data + INPUT_LENGTH_ONE * i),
                                           (void *)(std::get<1> (data)[i]),
                                           INPUT_LENGTH_ONE * sizeof (float) * 2, cudaMemcpyHostToDevice));
            ...
            gpuErrchk (cudaMemcpy ((void *)host_output_data, (void *)output_data,
                                   OUTPUT_LENGTH * sizeof (float) * 2, cudaMemcpyDeviceToHost));
